...
(5, 39, '성산일출봉', '제주특별자치도 서귀포시 성산읍 성산리', 56789, 76, '유네스코 세계자연유산', 33.458031, 126.942520, 1500, '2023-08-09 10:00:00', 'TOUR'),
(6, 39, '중문관광단지', '제주특별자치도 서귀포시 중문관광로 72번길', 67890, 76, '아름다운 해변과 리조트', 33.246877, 126.412535, 1100, '2023-08-09 10:00:00', 'TOUR'),
(7, 39, '한라산국립공원', '제주특별자치도 제주시 1100로 2070-61', 78901, 76, '제주의 상징, 한라산', 33.361900, 126.529160, 1300, '2023-08-09 10:00:00', 'TOUR'),
(8, 39, '우도', '제주특별자치도 제주시 우도면', 89012, 76, '아름다운 섬', 33.506111, 126.951389, 1000, '2023-08-09 10:00:00', 'TOUR'),
(9, 6, '해운대 해수욕장', '부산광역시 해운대구 해운대해변로 264', 90123, 76, '부산의 대표 해변', 35.158796, 129.160311, 1400, '2023-08-09 10:00:00', 'TOUR'),
(10, 6, '감천문화마을', '부산광역시 사하구 감내2로 203', 12345, 76, '부산의 마추픽추', 35.097859, 129.010021, 1000, '2023-08-09 10:00:00', 'TOUR'),
(11, 6, '자갈치시장', '부산광역시 중구 자갈치해안로 52', 23456, 82, '부산의 대표 수산시장', 35.096701, 129.030782, 800, '2023-08-09 10:00:00', 'TOUR'),
(12, 6, '태종대', '부산광역시 영도구 전망로 24', 34567, 76, '멋진 해안 절경', 35.053435, 129.087234, 900, '2023-08-09 10:00:00', 'TOUR'),
(13, 32, '속초해변', '강원도 속초시 조양동', 45678, 76, '동해의 아름다운 해변', 38.191368, 128.601754, 1100, '2023-08-09 10:00:00', 'TOUR'),
(14, 32, '설악산국립공원', '강원도 속초시 설악산로 833', 56789, 76, '한국의 대표 산악 국립공원', 38.119289, 128.465549, 1300, '2023-08-09 10:00:00', 'TOUR'),
(15, 32, '남이섬', '강원도 춘천시 남산면 남이섬길 1', 67890, 76, '아름다운 호수 섬', 37.791350, 127.525319, 1000, '2023-08-09 10:00:00', 'TOUR'),
(16, 32, '강릉 경포대', '강원도 강릉시 저동 94', 78901, 76, '동해의 달맞이 명소', 37.805281, 128.896311, 900, '2023-08-09 10:00:00', 'TOUR');
...
(2, 2, 39, 'BEGIN', '2023-09-15', '2023-09-18', '제주도 자연 체험', '제주도의 아름다운 자연을 만끽하는 4일 여행', '2023-08-09 10:00:00', '2023-08-09 10:00:00'),
(3, 3, 6, 'BEGIN', '2023-10-01', '2023-10-03', '부산 먹방 여행', '부산의 맛있는 음식과 명소를 즐기는 3일 여행', '2023-08-09 10:00:00', '2023-08-09 10:00:00'),
(4, 4, 32, 'BEGIN', '2023-10-15', '2023-10-17', '강원도 힐링 여행', '강원도의 아름다운 자연에서 휴식을 취하는 3일 여행', '2023-08-09 10:00:00', '2023-08-09 10:00:00');
