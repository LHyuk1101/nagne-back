...
public class TemplateServiceTest {
  ...
  public void calculateDistance_ShouldReturnCorrectDistances() {
    ...
    assertEquals(559.0, response.getDistances().get(0),
      1.0); // Distance between Place 1 and Place 2
    assertEquals(368.0, response.getDistances().get(1),
      1.0); // Distance between Place 2 and Place 3
